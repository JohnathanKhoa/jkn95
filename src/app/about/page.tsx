      ...
      <div className="pt-24 flex flex-row items-center justify-center text-balance  antialiased opacity-100">
        ...
        <div className="flex flex-col items-center justify-center text-balance">
          ...
          <div className="text-pretty text-center px-8">
            ...
            <br />
            <br />
            Found interest building computers, and learning about technology at
            a young age
            <br />
            <br />
            ...
            <br />
            <br />
            Moved across the states for work, gaining valuable experience in the
            tech industry
            <br />
            <br />
            Now continuing pursuit for higher levels in career and personal
            growth
          </div>
        </div>
      </div>
